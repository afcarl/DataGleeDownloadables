...
df = pd.read_csv('geocodedcleandata.csv')
names = []
loc = []
# global API_HOST #= ""
# global DEFAULT_TERM #= ""
...
CONSUMER_KEY = "g0ykVzLjKuqFhxl0j0xRjA"
CONSUMER_SECRET = "EKLv9fSqp_DtlE22fM42cEQoEhU"
TOKEN = "bUXXq-gN4wnHpp_U9UG25eIDwGNRI41e"
TOKEN_SECRET = "38KtqejwkbgVL9WWcP3nWh8rIts"
...
if __name__ == '__main__':
    ...
    rating = []
    k = 0
    for i in range(12876, 28868):#28868):
        ...
        with open('u12876.csv', 'a') as csvfile:
            fieldnames = ['rating']
